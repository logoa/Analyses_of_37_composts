...
# Indicator Species Analysis----
  ...
  ## Table Indicator Analysis, Table S15-S17------
...
# Other analysis-----
  ...
  ## FASTA sequence indicative ASVs: important for future blast search----
 ...
 write.fasta(sequences = sequences[curs$ASV], names =  names(sequences[curs$ASV]),
  ...
  ## Not included: Known biocontrol strains----
  ...
  ## Not included: Co-occurance network-----
